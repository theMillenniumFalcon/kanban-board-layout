...
export default function KanbanView(): React.ReactElement {
    ...
    const onDragEnd = (result: DropResult): void => {
        ...
        const sourceList = updatedKanbanData.find((list) => {
            list.listName === source.droppableId
        });
        const destinationList = updatedKanbanData.find((list) => {
            list.listName === destination.droppableId
        });
